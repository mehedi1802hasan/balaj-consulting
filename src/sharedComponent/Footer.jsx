  ...
  return (
    <div>
      ...
      <div className="md:flex lg:flex  justify-center mt-10 md:mt:44 items-center lg:gap-14 lg:mt-36 lg:mb-24">
        ...
        <div>
          <div className="w-[260px]  mx-auto md:mx-0 lg:ms-0 md:w-[461px] lg:w-[461px] mt-16 md:mt-36 lg:mt-36">
            ...
            <p className="text-[14px] text-center md:text-start lg:text-start md:text-[18px] lg:text-[18px] text-[#A6A6A6]  my-8 ">
              _ Aria Zinanrio
            </p>
          </div>
        ...
        <div className="w-[340px] mx-auto md:mx-0 lg:ms-0 md:w-[612px] lg:w-[612px] text-white h-[458px] md:h-[558px]  lg:h-[558px] rounded-[20px] flex justify-center items-center bg-[#FF8700]">
          <div className="lg:-mt-8">
            <div className="">
              <img
                className=" w-[42px] md:w-[72px] lg:w-[72px] mx-auto"
                src={coinicon}
                alt=""
              />
              <h3 className="text-center text-[16px] md:text-[32px] lg:text-[32px] mt-1 mb-2 md:mb-3 lg:mb-3">
                Get Started
              </h3>
            </div>
            <div className="w-[260px] md:w-[440px] lg:w-[440px] mx-auto ">
              <div>
                <h3 className=" text-[14px] md:text-[18px] lg:text-[18px] font-semibold">
                  Email
                </h3>
                <input
                  type="text"
                  className=" text-black w-full mt-1  md:mt-3 lg:mt-3 mb-3 md:mb-4 lg:mb-4 h-[40px] md:h-[45px] lg:h-[50px] rounded-lg px-4"
              ...
              <div>
                ...
                <input
                  type="text"
                  className="text-black w-full  my-1 md:my-4 lg:my-4 h-[60px]  md:h-[70px]  lg:h-[80px] rounded-lg px-3"
      ...
      <footer className="footer w-[300px]  lg:w-[1200px] mx-auto p-2 md:p-8 lg:p-10 mt-9 text-base-content">
        ...
        <div className="flex lg:flex-none  justify-between lg:justify-start gap-2 w-[300px] lg:w-full mx-auto md:mx-0 lg:mx-0  lg:gap-24">
          <div className="text-[#A6A6A6]  flex flex-col gap-2 ">
            <a className="link link-hover">Solutions</a>
            <a className="link link-hover">Legal_Info</a>
