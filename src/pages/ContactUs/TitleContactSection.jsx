...
const TitleContactSection = () => {
    return (
        <div className='w-[350px] lg:w-[842px] mx-auto my-10'>
       ...
       <p className='w-[300px] md:w-[570px] lg:w-[570px] my-6 lg:leading-8 font-semibold  text-center mx-auto text-[16px] text-[#000000]' >Varius amet, integer tellus non eget viverra. Ultrices tellus donec gravida id sed senectus dolor cursus sed. Ullamcorper tellus ac cras nec, pretium laoreet duis. </p>
