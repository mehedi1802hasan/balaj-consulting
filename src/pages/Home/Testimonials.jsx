...
const Testimonials = () => {
  return (
    <div>
      <h4 className="text-center mt-28 font-bold text-[38px] lg:text-[52px]">
        Trusted by over 1000+ customers
      </h4>
      <div className="lg:flex justify-between lg:ml-20 items-center lg:w-[1200px]   mt-7 lg:mt-12 mb-5 lg:mb-9  ">
        ...
        <div className="w-[260px] mx-auto mt-4 md:mt-0 lg:mt-0 lg:w-[780px]   ">
          ...
          <div className="lg:flex items-center text-[18px] gap-3  text-[#000000] mt-4 lg:mt-6 mb-3">
        ...
        <div2 className="w-[260px] lg:pt-48 mt-4 mx-auto  md:mt-0 lg:mt-0 lg:w-[780px]   ">
          ...
          <hr className="border-[#FF8700] border-[1.5px] w-full mx-auto" />
           ...
           <div className="lg:w-[550px]  mt-8">
            <h3 className=" text-[35px] text-center lg:text-start lg:text-[50px] lg:leading-[60px] w-full lg:w-11/12  font-semibold text-[#191A15]">Our positive reviews do speak, we don’t</h3>
                     
                     
            <div className="border mx-auto lg:mx-0 font-bold border-black flex items-center gap-2 px-3 w-[220px] justify-center  h-10 mt-5 rounded-3xl">
            Read Testimonials{" "}
